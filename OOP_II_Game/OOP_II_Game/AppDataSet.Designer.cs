...
namespace OOP_II_Game {
    ...
    public partial class AppDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string username, string password, string fullname, string phonenumber, string address, string city, string country, string email) {
...
namespace OOP_II_Game.AppDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([username], [password], [fullname], [phonenumber], [address], [city], [country], [email]) VALUES (@username, @password, @fullname, @phonenumber, @address, @city, @country, @email);
SELECT username, password, fullname, phonenumber, address, city, country, email FROM Users WHERE (username = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [username] = @username, [password] = @password, [fullname] = @fullname, [phonenumber] = @phonenumber, [address] = @address, [city] = @city, [country] = @country, [email] = @email WHERE (([username] = @Original_username) AND ([password] = @Original_password) AND ([fullname] = @Original_fullname) AND ((@IsNull_phonenumber = 1 AND [phonenumber] IS NULL) OR ([phonenumber] = @Original_phonenumber)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_country = 1 AND [country] IS NULL) OR ([country] = @Original_country)) AND ([email] = @Original_email));
SELECT username, password, fullname, phonenumber, address, city, country, email FROM Users WHERE (username = @username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::OOP_II_Game.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, fullname, phonenumber, address, city, country, email F" +
                "ROM dbo.Users";
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_fullname, string Original_phonenumber, string Original_address, string Original_city, string Original_country, string Original_email) {
        ...
        public virtual int Insert(string username, string password, string fullname, string phonenumber, string address, string city, string country, string email) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string fullname, string phonenumber, string address, string city, string country, string email, string Original_username, string Original_password, string Original_fullname, string Original_phonenumber, string Original_address, string Original_city, string Original_country, string Original_email) {
            return this.Update(Original_username, password, fullname, phonenumber, address, city, country, email, Original_username, Original_password, Original_fullname, Original_phonenumber, Original_address, Original_city, Original_country, Original_email);
        }
    }
